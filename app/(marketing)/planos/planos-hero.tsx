...
import { ArrowRight, PackageCheck, ShieldCheck, Rocket, Headset } from "lucide-react";

import { trackDemoClick } from "@/lib/analytics/track-events";

const WHATSAPP_HREF = "https://wa.me/5511939337163";

// Blur-in em mola com entrada escalonada (mesmo padrão da página de segurança).
const blurInItem = {
...
const BADGES = [
    { icon: PackageCheck, label: "Tudo incluído" },
    { icon: ShieldCheck, label: "Sem add-ons escondidos" },
    { icon: Rocket, label: "Implantação assistida" },
    { icon: Headset, label: "Suporte dedicado + gerente" },
];
        ...
        <MotionConfig reducedMotion="user">
            <section className="relative overflow-hidden bg-[#0B2440]">
                ...
                <div aria-hidden className="pointer-events-none absolute inset-0">
                    <div className="absolute -top-40 left-1/2 h-[40rem] w-[40rem] -translate-x-1/2 rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(250,96,7,0.18)_0%,rgba(250,96,7,0)_70%)]" />
                    <div className="absolute -bottom-48 -right-24 h-[32rem] w-[32rem] rounded-full bg-[radial-gradient(50%_50%_at_50%_50%,rgba(1,85,126,0.35)_0%,rgba(1,85,126,0)_70%)]" />
                    <div className="absolute inset-0 [background:radial-gradient(125%_125%_at_50%_0%,transparent_40%,rgba(7,24,42,0.85)_100%)]" />
                </div>
                ...
                <div className="relative mx-auto max-w-5xl px-6 pb-20 pt-32 text-center sm:pt-40 lg:pb-28">
                    <motion.div initial="hidden" animate="visible" variants={container}>
                        ...
                        >
                            Uma plataforma. Tudo o que sua operação precisa.
                        </motion.h1>
                        ...
                        >
                            Sem combos confusos nem recursos travados atrás de upgrade. Você leva a solução
                            completa, com preço sob medida para o tamanho da sua operação.
                        </motion.p>
