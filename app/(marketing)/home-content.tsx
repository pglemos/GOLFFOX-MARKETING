                ...
                <section id="faq" className="bg-white px-5 py-20 sm:px-8 lg:py-24">
                    <div className="mx-auto max-w-[820px]">
                        ...
                        <div className="flex flex-col gap-3.5">
                            {FAQS.map((faq, i) => (
                                <details key={faq.q} className="gf-faq rounded-[14px] border border-[#E7EDF3] bg-white px-6" open={i === 0}>
                                    ...
                                    <p className="mb-[22px] text-base leading-relaxed text-[#52647A]">{faq.a}</p>
                                </details>
                            ))}
                        </div>
                    </div>
