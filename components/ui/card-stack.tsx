                        ...
                        {items.map((item, i) => {
                            ...
                            return (
                                <motion.div
                                    key={item.id}
                                    className={cn(
                                        "absolute bottom-0 overflow-hidden rounded-2xl shadow-xl ring-1 ring-black/5",
                ...
                <div className="mt-6 flex items-center justify-center gap-3">
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        on ? "bg-[#FA6007]" : "bg-[#0B2440]/25 hover:bg-[#0B2440]/45",
                                    )}
                    ...
                    {activeItem.href ? (
                        <Link
                            ...
                            className="text-[#52647A] transition hover:text-[#0B2440]"
        ...
        <div className="relative h-full w-full">
            <div className="absolute inset-0">
                {item.imageSrc ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-[#F4F7FA] text-sm text-[#52647A]">Sem imagem</div>
                )}
            </div>
